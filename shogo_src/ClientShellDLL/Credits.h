...
public:
	...
	DBOOL				Init (CClientDE* pClientDE, CRiotClientShell* pClientShell, int nMode = CM_CREDITS, DBOOL bClearScreen = DTRUE);
	...
	DBOOL				IsDemoIntro() { return(m_nMode == CM_DEMO_INTRO); }
