...
// For MID_ULTRAHEAL, the message should contain 1 DFLOAT that represents the
// heal amount
#define MID_ULTRAHEAL				1004
...
#define MID_INVENTORYITEMTOUCH		1007
...
#define MID_INVENTORYITEMQUERY		1008
...
// the name of the item (should both be the same as in the query), and 1 DBYTE
// that specifies if we have the item (1) or not (0).
#define MID_INVENTORYQUERYRESPONSE	1009
